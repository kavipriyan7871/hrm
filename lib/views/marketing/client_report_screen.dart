      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Summarize the meeting with ${widget.task['customer_name'] ?? 'Client'}",
              style: GoogleFonts.poppins(
                fontSize: 14,
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        _summaryItem("Started At", widget.checkInTime),
                        _summaryItem("Ended At", checkOutTime),
                      ],
                    ),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        _summaryItem("Duration", "45 Minutes"),
                        _summaryItem("Client", widget.task['customer_name'] ?? "Lakshimi"),
                      ],
                    ),
                  ],
                ),
            ...
            _buildSection(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextField(_notesController, "Key points discussed...", 4),
                  const SizedBox(height: 20),
                  _fieldLabel("Next Meeting Schedule"),
                  _buildDatePicker(),
                ],
              ),
            ),
                ...
                children: [
                  Container(
                    ...
                    child: GestureDetector(
                      ...
                      child: CustomPaint(
                        painter: ClientSignaturePainter(points: _points),
                        size: Size.infinite,
                      ),
                    ),
                  ),
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          hint: Text("Select Engagement Status", style: GoogleFonts.poppins(fontSize: 13, color: Colors.grey.shade500)),
          isExpanded: true,
          value: selectedOutcome,
          items: ["Interested", "Follow-up Required", "Request for Proposal", "Closed"].map((e) {
...
class ClientSignaturePainter extends CustomPainter {
  final List<Offset?> points;

  ClientSignaturePainter({required this.points});
  ...
  @override
  bool shouldRepaint(ClientSignaturePainter oldDelegate) => true;
}
