...
import 'marketing_report_detail.dart';

class MarketingVisitScreen extends StatefulWidget {
  const MarketingVisitScreen({super.key});

  @override
  State<MarketingVisitScreen> createState() => _MarketingVisitScreenState();
}

class _MarketingVisitScreenState extends State<MarketingVisitScreen> {
  @override
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        MarketingReportDetailScreen(reportIndex: index),
                  ),
                );
              },
              child: Text(
